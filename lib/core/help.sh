...
show_clean_help() {
    ...
    echo "  --select          Interactively choose cleanup categories"
    echo "  --categories IDS  Clean only comma-separated category ids"
    echo "  --exclude IDS     Skip comma-separated category ids"
